...
{
  [Serializable()]
  internal class GreaterThanOrEqual: IExp
  {
    private IElement _lOperand;
    private IElement _rOperand;
    public GreaterThanOrEqual(IElement lOperand, IElement rOperand) {
      _lOperand = lOperand;
      _rOperand = rOperand;
    }
    public override object Clone() {
      return new GreaterThanOrEqual((IElement)_lOperand.Clone(), (IElement)_rOperand.Clone());
    }
