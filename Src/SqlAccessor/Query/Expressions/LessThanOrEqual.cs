...
{
  [Serializable()]
  internal class LessThanOrEqual: IExp
  {
    private IElement _lOperand;
    private IElement _rOperand;
    public LessThanOrEqual(IElement lOperand, IElement rOperand) {
      _lOperand = lOperand;
      _rOperand = rOperand;
    }
    public override object Clone() {
      return new LessThanOrEqual((IElement)_lOperand.Clone(), (IElement)_rOperand.Clone());
    }
