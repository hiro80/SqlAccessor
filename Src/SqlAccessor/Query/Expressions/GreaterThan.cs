...
{
  [Serializable()]
  internal class GreaterThan: IExp
  {
    private IElement _lOperand;
    private IElement _rOperand;
    public GreaterThan(IElement lOperand, IElement rOperand) {
      _lOperand = lOperand;
      _rOperand = rOperand;
    }
    public override object Clone() {
      return new GreaterThan((IElement)_lOperand.Clone(), (IElement)_rOperand.Clone());
    }
