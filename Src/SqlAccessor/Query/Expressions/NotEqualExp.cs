...
{
  [Serializable()]
  internal class NotEqualExp: IExp
  {
    private IElement _lOperand;
    private IElement _rOperand;
    public NotEqualExp(IElement lOperand, IElement rOperand) {
      _lOperand = lOperand;
      _rOperand = rOperand;
    }
    public override object Clone() {
      return new NotEqualExp((IElement)_lOperand.Clone(), (IElement)_rOperand.Clone());
    }
