...
[Serializable()]
public class PersonDefaultPH: IRecord
{
  ...
  public PersonDefaultPH() {
    this.Height = decimal.MinValue;
  }

  public PersonDefaultPH(int id, string name, DateTime birthDay, decimal height, decimal? weight, bool? isDaimyou, string remarks) {
    this.Id = id;
    this.Name = name;
  ...
  public static bool operator ==(PersonDefaultPH lOperand, PersonDefaultPH rOperand) {
