...
[Serializable()]
public class PersonNoPHcomment: IRecord
{
  ...
  public PersonNoPHcomment() {
    this.Height = decimal.MinValue;
  }

  public PersonNoPHcomment(int id, string name, DateTime birthDay, decimal height, decimal? weight, bool? isDaimyou, string remarks) {
    this.Id = id;
    this.Name = name;
  ...
  public static bool operator ==(PersonNoPHcomment lOperand, PersonNoPHcomment rOperand) {
